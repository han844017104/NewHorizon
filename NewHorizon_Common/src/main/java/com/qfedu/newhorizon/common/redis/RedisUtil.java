package com.qfedu.newhorizon.common.redis;
...
//=============================common============================
    ...
    public boolean zAdd(String key,Object value,Integer score,Integer time){
        try {
            redisTemplate.opsForZSet().add(key, value, score);
            redisTemplate.expire(key, time, TimeUnit.SECONDS);
            return true;
    ...
    public Long logAdd(String key,Object value){
        Long add = redisTemplate.opsForHyperLogLog().add(key, value);
        System.out.println("log return : "+add);
        return add;
    }

    public boolean addCheck(String key,Object value){
        Long sizebefore = logSize(key);
        System.out.println("sizebefore : " +sizebefore);
        redisTemplate.opsForHyperLogLog().add(key, value);
        Long sizeafter = logSize(key);
        System.out.println("sizeafter : "+sizeafter);
        if (sizebefore!=null&&sizeafter.equals(sizebefore)){
            return false;
        }else{
            return true;
        }
